...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      const categoryRes = await axios.get('https://api.cupagreen.com/api/get-category');
      console.log(categoryRes)
      const subcategoryRes = await axios.get('https://api.cupagreen.com/api/get-subcategories');
      const productRes = await axios.get('https://api.cupagreen.com/api/get-product');
      const productEnquiryRes = await axios.get('https://api.cupagreen.com/api/get-inquery');
      const contactEnquiryRes = await axios.get('https://api.cupagreen.com/api/get-contact-inquery');
