...
const EditSubcategory = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get('https://api.cupagreen.com/api/get-category'); // Fetch categories
    ...
    useEffect(() => {
        const fetchSubcategory = async () => {
            try {
                const response = await axios.get(`https://api.cupagreen.com/api/get-subcategories/${id}`); // Fetch subcategory by ID
                setSubcategory({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.cupagreen.com/api/update-subcategories/${id}`, {
