...
const AllProduct = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('http://localhost:8000/api/get-product'); // Replace with your actual endpoint
    ...
    const handleDelete = (productId) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`http://localhost:8000/api/delete-product/${productId}`); // Replace with your actual endpoint
                        ...
                        {loading ? (
                            ...
                            products.map((product, index) => (
                                <tr key={product._id}>
                                    ...
                                    <td>
                                        <img src={`http://localhost:8000/${product.productImage}`} alt={product.productName} width="50" height="50" />
                                    </td>
                                    <td>
