...
const EditCategory = () => {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`https://api.cupagreen.com/api/get-category/${id}`); // Update the endpoint as per your backend
                setCategory({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.cupagreen.com/api/update-category/${id}`, {
                name: category.name,
